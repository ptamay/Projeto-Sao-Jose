        ...
        <div className="login-page">
            ...
            <div className="login-container animate-slide">
                <div className="login-brand">
                    ...
                    <h1 className="login-title">
                        Colégio <span className="text-gradient-gold">São José</span>
                    </h1>
                ...
                <p className="login-footer-text">In Simplicitate Laboro - Acesso protegido</p>
            </div>
            ...
            <style jsx>{`
                ...
                .login-bg-orb-1 {
                    ...
                    background: radial-gradient(circle, rgba(30,53,99,0.6) 0%, transparent 70%);
                ...
                .login-logo-wrap {
                    ...
                    box-shadow: 0 0 32px rgba(196,154,48,0.3);
                }
                ...
                .input-action-btn:hover { color: var(--text-gold); }
